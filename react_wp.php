<?php
/*
Plugin Name: Sofas Plugin
Description: Use the [Sofas] shortcode to display the plugin
Version: 0.0.1
Author: Juan Ubau
...
class Sofas {
    ...
    */
    ...
    function add_type_attribute_front($tag, $handle, $src) {        
        ...
        if ($handle  === 'Sofas-plugin-dev' || $handle  === 'Sofas-plugin-prod') {
            $tag = '<script type="module" src="' . esc_url($src) . '"></script>';
            return $tag;
        } else if ($handle  === 'Sofas') {
            $tag = '<script type="module" src="' . esc_url($src) . '"></script>';
            return $tag;
        }
    ...
    function plugin_shortcode( $atts ) {
        ...
        */
        $tag = '<div id="Sofas" class="Sofas"></div>';
    ...
    function api_init() {
        register_rest_route('Sofas/v1', '/user/', [
            'methods'   => 'GET',
    ...
    */
    function init() {
        add_shortcode( 'Sofas', [$this, 'plugin_shortcode'] );
